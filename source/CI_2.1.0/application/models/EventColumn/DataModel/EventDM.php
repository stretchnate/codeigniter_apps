...
class EventColumn_DataModel_EventDM extends BaseDM {
	...
	public function loadEventLocations() {
		...
		foreach ($locations as $location) {
			$location = new EventColumn_DataModel_EventLocationDM();
	 ...
	 *
	 * @todo rewrite this method, have it call all locationDM::save() methods after the event is saved.
	 * @access public
	 * @return mixed
	 * @since  1.0
	 */
