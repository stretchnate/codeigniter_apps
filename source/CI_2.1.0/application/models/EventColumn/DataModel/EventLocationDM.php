...
class EventColumn_DataModel_EventLocationDM extends BaseDM {
	...
	public function loadEventDetailsDM() {
		$this->event_details_dm = new EventColumn_DataModel_EventDetailsDM();
	 ...
	 * @todo rewrite this method, have it save the DetailDM before the location is saved.
	 *
	 * @access public
	 * @return mixed
	 * @since  1.0
	 ...
	 *
	 * @return Object EventColumn_DataModel_EventDetailsDM
	 * @since  1.0
	 */
	 ...
	 * @since  1.0
	 */
	public function setEventDetailsDM(EventColumn_DataModel_EventDetailsDM $event_details_dm) {
