<?php
    ...
    abstract class Form_Field {
        ...
        const LABEL_PLACEMENT_LEFT      = 'left';
        const LABEL_PLACEMENT_RIGHT     = 'right';
        ...
        protected $label_placement       = self::LABEL_PLACEMENT_LEFT;
        ...
        protected function renderField( $field ) {
            ...
            <div<?=( $this->container_class ) ? " class='" . $this->container_class . "'" : ''; ?><?=isset( $this->container_id ) ? " id='" . $this->container_id . "'" : ""; ?>>
                <?
                if($this->label_placement == self::LABEL_PLACEMENT_LEFT) {
                    $this->generateLabel();
                } ?>
                ...
                <?
                if($this->label_placement == self::LABEL_PLACEMENT_RIGHT) {
                    $this->generateLabel();
                } ?>
            </div>
            <?php
        ...
        public function setLabelPlacement($label_placement) {
            $this->label_placement = strtolower(trim($label_placement));
        }
