 ...
 * @return String
 */
function UserFriendlyTransactionDetails($transaction) {
 ...
 * @throws Exception
 */
function transactionDetails($transactions, $specified_transaction, $user_id) {
    ...
    if ($transaction->getStructure()->getToAccount()) {
        $to_account = new Budget_DataModel_AccountDM($transaction->getStructure()->getToAccount(), $user_id);
    ...
    if ($transaction->getStructure()->getFromAccount()) {
        $from_account = new Budget_DataModel_AccountDM($transaction->getStructure()->getFromAccount(), $user_id);
